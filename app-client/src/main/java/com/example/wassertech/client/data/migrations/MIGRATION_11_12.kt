...
val MIGRATION_11_12 = object : Migration(11, 12) {
    override fun migrate(database: SupportSQLiteDatabase) {
        Log.d("MIGRATION_11_12", "Начало миграции: добавление поддержки иконок")
        ...
        Log.d("MIGRATION_11_12", "Миграция завершена: таблицы иконок созданы, поля icon_id добавлены")
    }
}
