...
object UserAuthService {
     ...
     */
    fun saveLogin(context: Context, userInfo: UserInfo, isOfflineMode: Boolean = false) {
        val prefs = getSharedPreferences(context)
        val now = System.currentTimeMillis()
        
        // Сохраняем текущего пользователя
        prefs.edit()
            .putString(KEY_CURRENT_USER_ID, userInfo.userId)
        ...
        val existingUserIndex = localUsers.indexOfFirst { it.userId == userInfo.userId }
        ...
        val localUserInfo = LocalUserInfo(
            ...
            lastRemoteLoginAtEpoch = userInfo.lastLoginAtEpoch // Время последнего входа в удаленной БД
        )
            ...
            for (i in 0 until jsonArray.length()) {
                ...
                users.add(
                    LocalUserInfo(
                        ...
                        role = jsonObj.optString("role", "USER"),
